...
int main(int argc, char *argv[]) {
    ...
    // Opcional: Cifrar los datos procesados antes de enviarlos de vuelta
    // En este caso, no es necesario, pero si deseas hacerlo, puedes cifrar aquí
    // caesar_cipher_encrypt(subDataProcessed, localSize, shift);
    ...
    if (rank == 0) {
        // Si los datos fueron cifrados al enviarlos de vuelta, descifrarlos aquí
        // caesar_cipher_decrypt(newData, bmpInfoHeader.imageSize, shift);
